...
SendtoDisplay:
    ...
    Private Sub btnExit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs, cancellationTokenSource As CancellationTokenSource) Handles btnExit.Click
        Try
            f.Close()
            Dim frm As Frmpassword = New Frmpassword
            f = frm
